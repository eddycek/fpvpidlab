...
|----------|--------|-------------|
| [TUNING_PRECISION_IMPROVEMENTS](./TUNING_PRECISION_IMPROVEMENTS.md) | **Active** | Research-based tuning accuracy improvements: ~~Wiener deconvolution~~ (done), ~~proportional PID scaling~~ (done), ~~data quality scoring~~ (done), ~~flight quality score~~ (done), throttle spectrograms, chirp analysis |
...
| [QUICK_TUNE_WIENER_DECONVOLUTION](./complete/QUICK_TUNE_WIENER_DECONVOLUTION.md) | Single-flight Flash Tune mode via Wiener deconvolution: transfer function estimation, Bode plots, dual-mode tuning (Deep Tune vs Flash Tune) |
...
| [TUNING_WORKFLOW_REVISION](./complete/TUNING_WORKFLOW_REVISION.md) | Stateful Deep Tune workflow (10-phase state machine) |
