...
**Unit tests:** 2593 tests across 130 files — MSP protocol, storage managers, IPC handlers, UI components, hooks, BBL parser fuzz, analysis pipeline validation, telemetry, license, auto-updater.
